...
\title[Introducción a la navegación autónoma]{Introducción a la navegación autónoma para robots móviles}
\author[Marco Negrete]{Marco Negrete}
\institute[FI, UNAM]{Facultad de Ingeniería, UNAM}
\date[EIR 2024-2025]{Escuela de Invierno de Robótica 2024-2025}
...
\begin{frame}\frametitle{Contenido}
  ...
  \item Planeación de rutas
    \begin{itemize}
    \item Métodos basados en grafos: BFS, DFS, Dijkstra, A*
    \item Métodos basados en muestreo: RRT
    \end{itemize}
  \item Seguimiento de rutas
    \begin{itemize}
    \item Modelos cinemáticos: base diferencial, omnidireccional y Ackermann
    \item Control de posición
    \end{itemize}
  \item Localización
    \begin{itemize}
    \item Filtros Bayesianos: Filtro de Kalman y Filtros de Partículas
  ...
  \item Navegación sin mapa
    \begin{itemize}
    \item Comportamientos mediante redes neuronales 
    \end{itemize}
  \end{itemize}
\end{frame}
