...
def get_inflated_map():
    ...
    clt_inflated   = rospy.ServiceProxy("/map_augmenter/get_augmented_map", GetMap)
    try:
...
def main():
    ...
    rospy.Service('/path_planner/plan_path_with_static'  , GetPlan, callback_rrt)
    rospy.Service('/path_planner/plan_path_with_augmented'  , GetPlan, callback_rrt)
